...
const packages: Package[] = [
  ...
  { qty: 1000, priceBRL: 24.90, discountPct: 0.50 },
  { qty: 2000, priceBRL: 44.90, discountPct: 0.55, bestChoice: true },
  { qty: 3000, priceBRL: 64.90, discountPct: 0.58 },
  { qty: 5000, priceBRL: 99.90, discountPct: 0.60 },
  { qty: 10000, priceBRL: 189.90, discountPct: 0.62 },
];

const YouTubeLikes: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-center">Curtidas no YouTube</h1>
      </motion.div>
