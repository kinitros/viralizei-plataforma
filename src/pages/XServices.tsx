...
const XServices: React.FC = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
      ...
      >
        <SocialIcon platform="twitter" size={32} className="text-black" />
        <h1 className="text-3xl md:text-4xl font-bold">Serviços X (Twitter)</h1>
      </motion.div>
          ...
          >
            <div>
              <div className="flex items-center space-x-3">
                <SocialIcon platform="twitter" size={24} className="text-black" />
