...
const services: ServiceItem[] = [
  {
    ...
    ctaLink: '/tiktok/seguidores-mundiais',
  },
  {
    ...
    ctaLink: '/tiktok/seguidores-brasileiros',
  },
  {
    ...
    ctaLink: '/tiktok/curtidas-mundiais',
  },
  {
    ...
    ctaLink: '/tiktok/curtidas-brasileiras',
  },
  {
    title: 'Visualizações',
    badges: [
    ...
    <section className="bg-gray-50 py-16">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Serviços para TikTok</h1>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="flex items-center space-x-4">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-gradient-to-br from-black to-gray-800 text-white">
                  <SocialIcon platform="tiktok" size={24} className="text-white" />
                </div>
                <div>
