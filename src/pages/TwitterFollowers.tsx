...
const packages: Package[] = [
  { qty: 250, priceBRL: 39.90, discountPct: 0.35 },
  { qty: 500, priceBRL: 69.90, discountPct: 0.40 },
  { qty: 1000, priceBRL: 119.90, discountPct: 0.45 },
  { qty: 2000, priceBRL: 239.90, discountPct: 0.50 },
  { qty: 3000, priceBRL: 349.90, discountPct: 0.55 },
  { qty: 5000, priceBRL: 569.90, discountPct: 0.58 },
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-center">Seguidores no Twitter</h1>
      </motion.div>
        ...
        {packages.map((pkg, idx) => (
          ...
          >
            <ServicePriceCard
              ...
              onBuy={() => {
                import('@/lib/checkout').then(({ openCheckout }) => openCheckout('twitter.followers', pkg.qty));
              }}
            />
          </motion.div>
        ))}
