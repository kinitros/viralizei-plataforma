...
const packagesWorld: Package[] = [
  ...
  { qty: 2000, priceBRL: 39.90, discountPct: 50 },
  { qty: 3000, priceBRL: 59.90, discountPct: 50 },
  { qty: 5000, priceBRL: 89.90, discountPct: 55 },
  { qty: 10000, priceBRL: 159.90, discountPct: 60 },
];

const InstagramLikesWorldwide: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-center">Curtidas Mundiais no Instagram</h1>
        <p className="text-gray-700 text-center">(Curtidas do mundo inteiro)</p>
      </motion.div>
        ...
        {packagesWorld.map((pkg, idx) => (
          ...
          >
            <ServicePriceCard
              ...
              onBuy={() => {
                import('@/lib/checkout').then(({ openCheckout }) => openCheckout('instagram.likes.world', pkg.qty));
              }}
            />
          </motion.div>
        ))}
...
export default InstagramLikesWorldwide;