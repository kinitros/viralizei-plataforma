...
const packagesWorld: Package[] = [
  { qty: 500, priceBRL: 24.90, discountPct: 0.44 },
  { qty: 1000, priceBRL: 44.90, discountPct: 0.40 },
  { qty: 2000, priceBRL: 89.90, discountPct: 0.45, bestChoice: true },
  { qty: 3000, priceBRL: 134.90, discountPct: 0.58 },
  { qty: 5000, priceBRL: 224.90, discountPct: 0.60 },
  { qty: 10000, priceBRL: 429.90, discountPct: 0.62 },
];

const TiktokFollowersWorldwide: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        ...
        <p className="text-gray-700 text-center">Mundiais (Seguidores do mundo inteiro)</p>
      </motion.div>
...
export default TiktokFollowersWorldwide;