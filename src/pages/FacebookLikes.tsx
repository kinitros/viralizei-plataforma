...
const packages: Package[] = [
  { qty: 500, priceBRL: 14.90, discountPct: 0.40 },
  { qty: 1000, priceBRL: 29.90, discountPct: 0.45 },
  { qty: 2000, priceBRL: 59.90, discountPct: 0.48, bestChoice: true },
  { qty: 3000, priceBRL: 89.90, discountPct: 0.50 },
  { qty: 5000, priceBRL: 149.90, discountPct: 0.55 },
  { qty: 10000, priceBRL: 299.90, discountPct: 0.60 },
];

const FacebookLikes: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-center">Curtidas no Facebook</h1>
      </motion.div>
        ...
        {packages.map((pkg, idx) => (
          ...
          >
            <ServicePriceCard
              ...
              onBuy={() => {
                import('@/lib/checkout').then(({ openCheckout }) => openCheckout('facebook.likes.world', pkg.qty));
              }}
            />
          </motion.div>
        ))}
