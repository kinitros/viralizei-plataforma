...
const services: ServiceItem[] = [
  {
    ...
    badges: [
      ...
      { label: 'GLOBAL', variant: 'warning' },
    ],
    ctaLink: '/instagram/seguidores-mundiais',
  },
  {
    ...
    ctaLink: '/instagram/seguidores-brasileiros',
  },
  {
    ...
    ctaLink: '/instagram/curtidas-mundiais',
  },
  {
    ...
    ctaLink: '/instagram/curtidas-brasileiras',
  },
  {
    title: 'Visualizações Reels',
    badges: [
      { label: 'Entrega Rápida', variant: 'success' },
      { label: 'Reels', variant: 'default' },
    ],
    ctaLink: '/instagram/visualizacoes-reels',
  },
  {
    title: 'Visualizações Stories',
    badges: [
      { label: 'Entrega Rápida', variant: 'success' },
      { label: 'Stories', variant: 'default' },
    ],
    ctaLink: '/instagram/visualizacoes-stories',
  },
];
    ...
    <section className="bg-gray-50 py-16">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Serviços para Instagram</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 flex flex-col md:flex-row md:items-center md:justify-between"
            >
              <div className="flex items-center space-x-4">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-gradient-to-br from-pink-500 to-purple-600 text-white">
                  <SocialIcon platform="instagram" size={24} className="text-white" />
                </div>
                <div>
              ...
              <motion.a
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-4 py-2 rounded-lg shadow w-full md:w-auto mt-4 md:mt-0 text-center"
