...
const packages: Package[] = [
  { qty: 500, priceBRL: 29.90, discountPct: 0.40 },
  { qty: 1000, priceBRL: 49.90, discountPct: 0.42 },
  { qty: 2000, priceBRL: 99.90, discountPct: 0.45 },
  { qty: 3000, priceBRL: 149.90, discountPct: 0.50 },
  { qty: 5000, priceBRL: 229.90, discountPct: 0.55 },
  { qty: 10000, priceBRL: 449.90, discountPct: 0.60 },
];

const TwitterLikes: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-center">Curtidas no Twitter</h1>
      </motion.div>
