...
const packagesBR: Package[] = [
  ...
  { qty: 5000, priceBRL: 149.90, discountPct: 52 },
  { qty: 10000, priceBRL: 299.90, discountPct: 55 },
];

const TiktokLikesBrazil: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        ...
        <p className="text-gray-700 text-center">Brasileiras</p>
      </motion.div>
...
export default TiktokLikesBrazil;