...
// Preços conforme imagem enviada para Curtidas Brasileiras
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-center">Curtidas Brasileiras Kwai</h1>
      </motion.div>
