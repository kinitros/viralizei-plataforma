...
// Preços conforme imagem enviada para Seguidores Brasileiros Kwai
...
const KwaiFollowersBrazil: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-center">Seguidores Brasileiros Kwai</h1>
      </motion.div>
      ...
      <div className="max-w-2xl mx-auto mb-10 text-center">
        ...
        <p className="text-gray-700 mt-2">
          Após a finalização do pagamento você terá o acesso ao nosso whatsapp pra enviar o link do perfil e receber nossos seguidores e suporte
        </p>
      </div>
        ...
        {packages.map((pkg, idx) => (
          ...
          >
            <ServicePriceCard
              ...
              headerBgClass={getHeaderBgClass('kwai', true)}
              discountBadgeClass="bg-white text-red-600 border border-red-600"
              bestChoice={pkg.bestChoice}
              buttonText="Comprar Agora"
              onBuy={() => {
                redirectToService({ platform: 'kwai', type: 'followers', region: 'br' }, pkg.qty);
              }}
            />
          </motion.div>
        ))}
...
export default KwaiFollowersBrazil;