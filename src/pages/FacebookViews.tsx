...
const packages: Package[] = [
  ...
  { qty: 1000, priceBRL: 34.90, discountPct: 0.42 },
  { qty: 2000, priceBRL: 64.90, discountPct: 0.45, bestChoice: true },
  { qty: 3000, priceBRL: 89.90, discountPct: 0.50 },
  { qty: 5000, priceBRL: 139.90, discountPct: 0.55 },
  { qty: 10000, priceBRL: 249.90, discountPct: 0.60 },
];

const FacebookViews: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-center">Visualizações no Facebook</h1>
      </motion.div>
