...
const InstagramViewsStories: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        <SocialIcon platform="instagram" size={36} className="text-orange-500" />
        <h1 className="text-3xl md:text-4xl font-bold text-center">Visualizações Stories no Instagram</h1>
        <p className="text-gray-700 text-center">(Visualizações em Stories)</p>
      </motion.div>
...
export default InstagramViewsStories;